              ...
              {showServant && (
                <div className="row">
                  ...
                  <div className="col-md-6">
                    ...
                    <input
                      value={maid.address}
                      onChange={(e) => handleMaidChange("address", e.target.value)}
                      type="text"
                      name="address"
                      placeholder="Address"
                      className="w-75 my-3 text-white py-2"
                    ...
                    <input
                      value={maid.guardian}
                      onChange={(e) => handleMaidChange("guardian", e.target.value)}
                      type="text"
                      name="guardian"
                  ...
                  <div className="col-md-6">
                    <input
                      value={maid.number}
                      onChange={(e) => handleMaidChange("number", e.target.value)}
                      type="tel"
                      name="number"
                    ...
                    <label className="w-75 my-3 text-white py-2" style={inputStyle}>
                    ...
                    <label className="w-75 my-3 text-white py-2" style={inputStyle}>
                      {maid.cantPassUrl ? "Cant Pass Uploaded" : "Upload Cant Pass"}
                      <input
                        type="file"
                        name="cantPassFile"
                        accept="image/*"
